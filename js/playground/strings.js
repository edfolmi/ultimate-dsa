...
const problemData = {
    problem1: {
        ...
        javascript: {
            ...
            testCases: [
                { input: ["abcabcbb"], expected: 3, desc: 's = "abcabcbb"' },
                { input: ["bbbbb"], expected: 1, desc: 's = "bbbbb"' },
                { input: ["pwwkew"], expected: 3, desc: 's = "pwwkew"' },
            ]
        },
        python: {
        ...
        cpp: {
            starter: `int lengthOfLongestSubstring(string s) {\n    // Write your code here\n    return 0;\n}`,
            testCases: []
        }
    }
};
    ...
    try {
        ...
        for (let i = 0; i < problem.testCases.length; i++) {
            ...
            try {
                let testCode = `
${code}
result = length_of_longest_substring(${JSON.stringify(test.input[0])})
`;
