...
const problemData = {
    problem1: {
        title: '1. Sort Colors (Dutch National Flag)',
        description: 'Sort an array with values 0, 1, and 2 in-place.',
        javascript: {
            starter: `function sortColors(nums) {\n    // Modify nums in-place\n    \n}`,
            testCases: [
                { input: [[2, 0, 2, 1, 1, 0]], expected: [0, 0, 1, 1, 2, 2], desc: '[2,0,2,1,1,0]' },
                { input: [[2, 0, 1]], expected: [0, 1, 2], desc: '[2,0,1]' },
        ...
        java: {
            starter: `public void sortColors(int[] nums) {\n    // Modify nums in-place\n}`,
            testCases: []
        },
        cpp: {
            starter: `void sortColors(vector<int>& nums) {\n    // Modify nums in-place\n}`,
            testCases: []
        }
    },
    problem2: {
        ...
        javascript: {
            ...
            testCases: [
                { input: [[[1, 3], [2, 6], [8, 10], [15, 18]]], expected: [[1, 6], [8, 10], [15, 18]], desc: '[[1,3],[2,6],[8,10],[15,18]]' },
                { input: [[[1, 4], [4, 5]]], expected: [[1, 5]], desc: '[[1,4],[4,5]]' },
                { input: [[[1, 4], [0, 4]]], expected: [[0, 4]], desc: '[[1,4],[0,4]]' },
            ]
        },
        python: {
        ...
        java: {
            starter: `public List<List<Integer>> merge(int[][] intervals) {\n    // Write your code here\n    return new ArrayList<>();\n}`,
            testCases: []
        },
        cpp: {
            starter: `vector<vector<int>> merge(vector<vector<int>>& intervals) {\n    // Write your code here\n    return {};\n}`,
            testCases: []
        }
    }
};
...
`;
                    ...
                    testCode = `
${code}
result = merge(${JSON.stringify(test.input[0])})
`;
                }
